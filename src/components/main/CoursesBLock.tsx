...
export const CoursesBlock: React.FC<CoursesBlockProps> = (props) => {
    const content = (
        <div className="flex flex-col gap-3 p-6 border-solid border-0.063rem border-gray rounded-lg 700:max-w-17rem w-full no-underline hover:shadow-lg transition-shadow">
