...
export const Profile = () => {
    return (
        <div className="flex flex-col gap-4 items-start w-full px-8">
            ...
            <div className="flex flex-col 1200:flex-row items-center w-full border-solid	border-[0.063rem] border-[#717389] rounded-lg px-[4rem] py-8">
                <div className="flex flex-col 1200:flex-row items-center gap-[3rem]">
                    <img src={avaProfile} alt="" />
                    <div className="flex flex-col gap-6  border-solid border-[0] 1200:border-r-[1px]  border-[#717389] pb-6 1200:pb-[0px] 1200:pr-[4.5rem]">
                ...
                <div className='flex flex-col pt-6 1200:pt-[0px] 1200:pl-[4.5rem] max-w-[27rem] gap-6'>
                    <h1 className="text-3xl 900:text-5xl font-bold">Skills:</h1>
                    <div className='flex flex-wrap gap-2'>
                        <Btn
                            title="Project Management"
                            className="bg-[#303240] border-solid	border-[0.063rem] border-[#717389]  hover:bg-[#717389] transition duration-300 "
