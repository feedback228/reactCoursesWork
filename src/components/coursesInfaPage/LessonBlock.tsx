...
export const LessonBlock: React.FC<LessonBlockProps> = (props) => {
    return (
        <div className="flex justify-between items-center border-solid w-full	border-0.063rem border-gray rounded-lg py-6 tablet:py-2 px-6 h-auto tablet:h-8rem">
            <div className="flex items-center gap-10">
                ...
                <div className="flex flex-col gap-5">
                    <div className="flex flex-col gap-2 max-w-36rem">
                        ...
                        <p className="font-medium text-sm 1000:text-lg text-ultraLigthGray 1000:text-white">
                            {props.description}
                        </p>
                    </div>
